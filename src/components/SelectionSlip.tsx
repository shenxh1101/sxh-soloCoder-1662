...
export function printSelectionSlip(order: Order, photos?: Photo[]) {
...
export default function SelectionSlip({
  ...
  return (
    <div className={cn('selection-slip', className)}>
      {showPrint && (
        <button onClick={() => printSelectionSlip(order, targetPhotos)} className="btn-secondary flex items-center gap-2 mb-4 no-print">
